    ...
    <main className={styles.main}>
      ...
      <section className={styles.section} id="migration-scenarios">
        ...
        <div className={styles.packageGrid}>
          <article className={styles.packageCard}><span className={styles.cardIconSmall}>01</span><h3>BIP 升迁与版本升级</h3><dl><div><dt>常见触发</dt><dd>U8 Cloud、NC、NC Cloud、YonBIP 高级版升迁到旗舰版、超级版或新版本。</dd></div><div><dt>关键动作</dt><dd>盘点组织、账簿、用户、人员、客户、科目、辅助核算、期初和凭证等对象，完成加载、转换、迁移和核对。</dd></div><div><dt>交付结果</dt><dd>升迁评估、对象清单、映射规则、试迁移报告、差异台账、正式切换确认。</dd></div></dl></article>
          <article className={styles.packageCard}><span className={styles.cardIconSmall}>02</span><h3>集团拆分、公司独立与审计抽取</h3><dl><div><dt>常见触发</dt><dd>子公司上市、业务剥离、组织重组、外部审计、历史数据独立保管。</dd></div><div><dt>关键动作</dt><dd>按公司、组织、账套、模块、年度抽取，隔离敏感数据，形成独立数据环境或审计数据包。</dd></div><div><dt>交付结果</dt><dd>抽取范围清单、独立库或数据包、抽取日志、审计核对报告、权限隔离说明。</dd></div></dl></article>
          <article className={styles.packageCard}><span className={styles.cardIconSmall}>03</span><h3>多单位、多账套数据同步</h3><dl><div><dt>常见触发</dt><dd>总部与子集团、内外账套、财务共享、多套业务系统需要周期同步或集中汇总。</dd></div><div><dt>关键动作</dt><dd>建立基础档案对照、同步任务中心、频率规则、异常重试、补偿机制和差异对账。</dd></div><div><dt>交付结果</dt><dd>同步方案、字段映射表、任务配置清单、异常处理规则、运行监控报告。</dd></div></dl></article>
          <article className={styles.packageCard}><span className={styles.cardIconSmall}>04</span><h3>历史凭证与业务数据延续</h3><dl><div><dt>常见触发</dt><dd>新系统上线后仍需查询历史凭证、余额、业务单据、审批记录、附件和电子档案。</dd></div><div><dt>关键动作</dt><dd>梳理历史期间、数据对象、单据链路、凭证规则、附件路径和查询权限。</dd></div><div><dt>交付结果</dt><dd>历史数据迁移清单、查询口径、凭证核对表、附件抽样记录、历史联查说明。</dd></div></dl></article>
          <article className={styles.packageCard}><span className={styles.cardIconSmall}>05</span><h3>移动审批与业务回写</h3><dl><div><dt>常见触发</dt><dd>审批待办需要进入钉钉、企业微信、OA 或移动端，审批结果要回写业务系统。</dd></div><div><dt>关键动作</dt><dd>梳理审批对象、字段、消息模板、附件预览、审批动作、状态回写和审计记录。</dd></div><div><dt>交付结果</dt><dd>审批集成方案、字段映射表、联调记录、消息推送配置、审批闭环报告。</dd></div></dl></article>
          <article className={styles.packageCard}><span className={styles.cardIconSmall}>06</span><h3>脱敏与安全共享</h3><dl><div><dt>常见触发</dt><dd>开发测试、外包分析、培训演示、跨系统共享需要使用真实结构数据。</dd></div><div><dt>关键动作</dt><dd>识别姓名、电话、证件、地址、银行卡、薪资等敏感字段，设计替换、掩码和扰动规则。</dd></div><div><dt>交付结果</dt><dd>敏感字段清单、脱敏规则、脱敏数据集、可用性验证、安全合规说明。</dd></div></dl></article>
          <article className={styles.packageCard}><span className={styles.cardIconSmall}>07</span><h3>业务数据转凭证与初始化</h3><dl><div><dt>常见触发</dt><dd>外部业务系统需要生成总账凭证，或系统重建时需要保留基础资料并清理业务数据。</dd></div><div><dt>关键动作</dt><dd>定义凭证模板、业务字段取数、摘要规则、辅助核算、期初口径、清理范围和保留范围。</dd></div><div><dt>交付结果</dt><dd>转凭证规则、初始化清单、凭证样例、导入日志、期初与凭证核对报告。</dd></div></dl></article>
          <article className={styles.packageCard}><span className={styles.cardIconSmall}>08</span><h3>云巡检、备份与回滚保障</h3><dl><div><dt>常见触发</dt><dd>迁移切换、系统升级、月结前后、重大业务窗口、补丁检查和安全检查要求。</dd></div><div><dt>关键动作</dt><dd>检查服务器、数据库、网络、补丁、备份、接口任务、业务指标和安全风险。</dd></div><div><dt>交付结果</dt><dd>巡检报告、风险等级、备份确认、恢复演练记录、回滚预案和问题闭环清单。</dd></div></dl></article>
        </div>
      </section>
      ...
      <section className={styles.sectionFluid} id="migration-objects">
        <div className={styles.sectionInner}>
          ...
          <div className={styles.packageGrid}>
            <article className={styles.packageCard}><span className={styles.cardIconSmall}>01</span><h3>主数据</h3><dl><div><dt>对象范围</dt><dd>客户、供应商、人员、组织、部门、物料、商品、BOM、计量单位。</dd></div><div><dt>常见风险</dt><dd>名称重复、编码不统一、停用数据未清理、关键字段缺失、BOM版本混乱。</dd></div><div><dt>核验口径</dt><dd>编码唯一性、启停状态、字段完整率、上下级关系、业务引用是否可用。</dd></div></dl></article>
            <article className={styles.packageCard}><span className={styles.cardIconSmall}>02</span><h3>财务数据</h3><dl><div><dt>对象范围</dt><dd>科目、辅助核算、期初余额、应收应付、凭证、现金银行和往来余额。</dd></div><div><dt>常见风险</dt><dd>辅助核算缺失、期初不平、往来余额不一致、凭证期间和状态异常。</dd></div><div><dt>核验口径</dt><dd>科目余额、辅助余额、借贷平衡、期间合计、凭证抽样和报表一致性。</dd></div></dl></article>
            <article className={styles.packageCard}><span className={styles.cardIconSmall}>03</span><h3>供应链与库存</h3><dl><div><dt>对象范围</dt><dd>仓库、库位、批次、序列号、库存期初、采购订单、销售订单和出入库单。</dd></div><div><dt>常见风险</dt><dd>账实不符、批次缺失、库位错误、未结订单状态不清、单位换算不一致。</dd></div><div><dt>核验口径</dt><dd>库存数量、金额、批次库位、未结业务、单据状态和新系统业务流转。</dd></div></dl></article>
            <article className={styles.packageCard}><span className={styles.cardIconSmall}>04</span><h3>生产与项目数据</h3><dl><div><dt>对象范围</dt><dd>生产订单、工序、工单、BOM版本、项目档案、项目预算、成本归集数据。</dd></div><div><dt>常见风险</dt><dd>生产状态断裂、成本对象不清、项目阶段不一致、历史成本口径无法追溯。</dd></div><div><dt>核验口径</dt><dd>在制状态、完工状态、BOM引用、项目余额、成本对象和关键业务追溯。</dd></div></dl></article>
            <article className={styles.packageCard}><span className={styles.cardIconSmall}>05</span><h3>历史单据与附件</h3><dl><div><dt>对象范围</dt><dd>历史订单、历史凭证、历史报表、审批记录、附件、影像、电子档案。</dd></div><div><dt>常见风险</dt><dd>关联关系断裂、附件路径失效、审批记录缺失、历史查询口径不一致。</dd></div><div><dt>核验口径</dt><dd>单据链路、凭证联查、附件打开、审批轨迹、历史期间和抽样业务场景。</dd></div></dl></article>
            <article className={styles.packageCard}><span className={styles.cardIconSmall}>06</span><h3>接口与同步数据</h3><dl><div><dt>对象范围</dt><dd>主数据同步、业务单据同步、凭证同步、审批回写、第三方系统回传数据。</dd></div><div><dt>常见风险</dt><dd>数据源头不清、重复推送、状态回写失败、异常补偿缺失、对账口径不一致。</dd></div><div><dt>核验口径</dt><dd>同步成功率、延迟、失败原因、重试结果、差异清单和业务闭环状态。</dd></div></dl></article>
          </div>
        </div>
      </section>
      ...
      <section className={styles.section} id="tool-matrix">
        ...
        <div className={styles.toolGrid4}>
          <article className={styles.toolCard}><span className={styles.cardIconSmall}>01</span><h3>数据抽取与系统拆分服务</h3><dl><div><dt>适用场景</dt><dd>公司独立、组织调整、审计数据提供、历史数据隔离和老系统瘦身。</dd></div><div><dt>执行动作</dt><dd>按公司、模块、年度、组织和账套抽取，支持抽取后独立部署或形成审计数据包。</dd></div><div><dt>交付物</dt><dd>抽取范围清单、抽取规则、独立库或数据包、抽取日志、核对报告。</dd></div><div><dt>验证口径</dt><dd>组织数、单据数、凭证数、金额合计、期间范围、附件可访问性。</dd></div></dl></article>
          <article className={styles.toolCard}><span className={styles.cardIconSmall}>02</span><h3>数据同步与集中管控服务</h3><dl><div><dt>适用场景</dt><dd>总部与子集团、内外账套、多系统部署、财务共享和跨版本数据汇总。</dd></div><div><dt>执行动作</dt><dd>建立基础档案对照、读取外部系统数据、转换字段、配置任务中心和异常补偿。</dd></div><div><dt>交付物</dt><dd>同步方案、字段映射表、任务配置清单、异常处理规则、运行监控报告。</dd></div><div><dt>验证口径</dt><dd>同步成功率、失败率、延迟时间、差异数据、业务单据闭环状态。</dd></div></dl></article>
          ...
          <article className={styles.toolCard}><span className={styles.cardIconSmall}>05</span><h3>业务数据转凭证服务</h3><dl><div><dt>适用场景</dt><dd>外部业务系统、线下台账或历史业务数据需要转成总账凭证进入财务系统。</dd></div><div><dt>执行动作</dt><dd>定义凭证模板、摘要规则、科目取值、辅助核算、借贷方向、金额来源和异常处理。</dd></div><div><dt>交付物</dt><dd>转凭证规则、凭证样例、导入模板、失败清单、总账核对报告。</dd></div><div><dt>验证口径</dt><dd>凭证数量、借贷平衡、科目和辅助核算完整率、金额汇总、凭证状态。</dd></div></dl></article>
      ...
      <section className={styles.sectionFluid}>
        <div className={styles.sectionInner}>
          ...
          <div className={styles.packageGrid3}>
            <article className={styles.packageCardSimple}><h3>升迁升级类</h3><p>适合系统平台升级、版本换代和数据资产延续。</p><ul className={styles.miniList}><li>YonBIP 旗舰版升迁</li><li>YonBIP 旗舰版升级</li><li>YonBIP 高级版升迁</li><li>组织、档案、财务和期初迁移</li></ul></article>
            <article className={styles.packageCardSimple}><h3>抽取归档类</h3><p>适合集团拆分、公司独立、审计提供和历史数据瘦身。</p><ul className={styles.miniList}><li>数据抽取工具</li><li>数据卸载工具</li><li>历史年度归档</li><li>独立库与审计数据包</li></ul></article>
            <article className={styles.packageCardSimple}><h3>同步集成类</h3><p>适合多系统并行、总部汇总、审批移动化和业务数据入账。</p><ul className={styles.miniList}><li>数据同步工具</li><li>移动审批工具</li><li>业务数据转凭证工具</li><li>基础档案对照与任务中心</li></ul></article>
            <article className={styles.packageCardSimple}><h3>迁移转换类</h3><p>适合历史凭证延续、第三方系统迁入和数据库切换。</p><ul className={styles.miniList}><li>数据迁移工具</li><li>数据库转换工具</li><li>SQL Server / Oracle 转换</li><li>金蝶、浪潮、SAP、Oracle 数据接入</li></ul></article>
            <article className={styles.packageCardSimple}><h3>安全合规类</h3><p>适合开发测试、外包分析、培训演示和跨系统共享。</p><ul className={styles.miniList}><li>数据脱敏工具</li><li>敏感字段识别</li><li>脱敏规则配置</li><li>可用性与安全验证</li></ul></article>
            <article className={styles.packageCardSimple}><h3>保障运行类</h3><p>适合上线切换、月结窗口、补丁升级和运维风险排查。</p><ul className={styles.miniList}><li>数据备份工具</li><li>云巡检工具</li><li>IPv6 升级评估</li><li>技术环境、应用指标、安全与补丁检查</li></ul></article>
          </div>
        </div>
      </section>
      ...
      <section className={styles.sectionFluid} id="regional-assurance">
        <div className={styles.sectionInner}>
          ...
          <div className={styles.localSegments}>
            <article className={styles.segmentCard}><h3>成长型客户</h3><p>以智能交付工具和标准化服务包为支撑，帮助快速上线、及时响应、持续运营；关键节点可按需本地支持。</p><ul className={styles.chipList}><li>智能交付</li><li>在线支持</li><li>标准服务包</li><li>按需现场</li></ul></article>
            <article className={styles.segmentCard}><h3>中大型客户</h3><p>在蓝图设计、集成联调、迁移切换、月结保障和重大问题处理等关键阶段提供本地化项目保障。</p><ul className={styles.chipList}><li>项目制保障</li><li>现场支持</li><li>专项响应</li><li>驻场服务</li></ul></article>
          </div>
      ...
      <section className={styles.sectionDiagnosis} id="diagnosis">
        <div className={styles.diagnosisContainer}>
          ...
          <form className={styles.leadForm} onSubmit={handleSubmit}>
            ...
            <button type="submit" className={styles.modalSubmit}>提交服务评估需求<svg viewBox="0 0 24 24" aria-hidden="true" width="18" height="18"><path d="M5 12h12.2l-5.1-5.1L14 5l8 8-8 8-1.9-1.9 5.1-5.1H5v-2Z" fill="currentColor" /></svg></button>
          </form>
        </div>
      </section>
    </main>
