            ...
            <div className="col-span-1 hidden md:flex md:flex-col gap-6 md:gap-10 md:contents">
              <div className="lg:col-span-2 md:col-span-1 lg:order-2 hidden md:block">
                ...
                <ul className="space-y-2.5 md:space-y-3 text-sm">
                  ...
                  <li><Link href="/products/bip" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center group"><span className="w-0 overflow-hidden transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:w-2 group-hover:mr-1 text-blue-600 dark:text-blue-400">•</span> <span>BIP</span></Link></li>
                  <li><Link href="/solution/erp-migration" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center group"><span className="w-0 overflow-hidden transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:w-2 group-hover:mr-1 text-blue-600 dark:text-blue-400">•</span> <span>ERP升级计划</span></Link></li>
                  <li><Link href="/solution/business/yonwork" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center group"><span className="w-0 overflow-hidden transition-all duration-300 opacity-0 group-hover:opacity-100 group-hover:w-2 group-hover:mr-1 text-blue-600 dark:text-blue-400">•</span> <span>YonWork 智能体</span></Link></li>
                </ul>
              </div>
